              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      Users.username,
                      style: appBarLabel.copyWith(fontSize: 22, color: Colors.black),
                    ),
                    SizedBox(height: 1),
                    Text(
                      'My doll',
                      style: appBarLabel.copyWith(fontSize: 12, color: purple4),
                    ),
                  ],
                ),
                Padding(
                  ...
                  child: IconButton(
                    ...
                    size: 40,
                    color: isPressed ? Colors.lightGreenAccent:Colors.black87), // Use Icon(Icons.bluetooth) directly
                    onPressed: () {
                      setState(() {
                        isPressed = !isPressed;
                      });
